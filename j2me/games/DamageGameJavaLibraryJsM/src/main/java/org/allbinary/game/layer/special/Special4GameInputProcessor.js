...
export class Special4GameInputProcessor extends SpecialGameInputProcessor {
    ...
    processEvent(allbinaryLayerManager, gameKeyEvent) {
        this.collidableDestroyableDamageableLayer.special4(allbinaryLayerManager, gameKeyEvent);
    }
}
