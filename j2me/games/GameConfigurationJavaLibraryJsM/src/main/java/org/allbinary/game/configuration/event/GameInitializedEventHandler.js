...
export class GameInitializedEventHandler extends BasicEventHandler {
    ...
    process(eventObject, eventListenerInterface) {
        var gameInitializedListenerInterface = eventListenerInterface;
        ;
        gameInitializedListenerInterface.onGameInitialized(eventObject);
    }
}
GameInitializedEventHandler.gameKeyEventHandler = new GameInitializedEventHandler();
