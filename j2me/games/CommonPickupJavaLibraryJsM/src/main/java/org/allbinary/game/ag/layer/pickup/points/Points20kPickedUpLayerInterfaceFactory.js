...
//not GWT import - same folder const PointsLayerCircularStaticPool
import { PointsLayerFactory } from './PointsLayerFactory.js';
//not GWT import - same folder const PointsLayerFactory
import { PointsResources } from './PointsResources.js';
//not GWT import - same folder const PointsResources
export class Points20kPickedUpLayerInterfaceFactory extends PickedUpLayerInterfaceFactory {
    ...
    constructor() {
        ...
        this.pool = new PointsLayerCircularStaticPool(new PointsLayerFactory(GameConfigurationUtil.getInstance().getCompetitionValue() * 20000), 1);
...
Points20kPickedUpLayerInterfaceFactory.pickedUpLayerInterfaceFactoryInterface = CountedPickedUpLayerInterfaceFactory.NULL_COUNTED_PICKUP_LAYER_FACTORY;
