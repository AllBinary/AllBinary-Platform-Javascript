...
StaticTileLayerIntoPositionViewPosition.tiledLayer = NullLayer.getInstance();
StaticTileLayerIntoPositionViewPosition.layer = AllBinaryLayer.NULL_ALLBINARY_LAYER;
