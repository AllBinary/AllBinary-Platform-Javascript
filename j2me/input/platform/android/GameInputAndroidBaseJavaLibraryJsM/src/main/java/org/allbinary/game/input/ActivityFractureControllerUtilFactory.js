...
//not GWT import const AndroidAPI12KeyFactory = globalThis.org.allbinary.game.input.AndroidAPI12KeyFactory;
...
export class ActivityFractureControllerUtilFactory extends Object {
    static getInstance() {
