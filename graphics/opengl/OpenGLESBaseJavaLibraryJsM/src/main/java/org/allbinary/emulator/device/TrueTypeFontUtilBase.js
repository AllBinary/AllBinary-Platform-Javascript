...
export class TrueTypeFontUtilBase extends Object {
    constructor(scale) {
        ...
        if (AvianUtil.isAvian()) {
            ...
            ;
            shortPattern = String.fromCharCode(...shortPatterAsByteArray);
        }
        else {
