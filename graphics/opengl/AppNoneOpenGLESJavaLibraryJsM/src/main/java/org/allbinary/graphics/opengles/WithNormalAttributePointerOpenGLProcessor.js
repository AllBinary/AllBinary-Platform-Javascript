...
export class WithNormalAttributePointerOpenGLProcessor extends ObjectThreedOpenGLProcessor {
    static getInstance() {
    ...
    process(gl, aObject3d = {}) {
        throw new RuntimeException();
    }
}
WithNormalAttributePointerOpenGLProcessor.instance = new WithNormalAttributePointerOpenGLProcessor();
