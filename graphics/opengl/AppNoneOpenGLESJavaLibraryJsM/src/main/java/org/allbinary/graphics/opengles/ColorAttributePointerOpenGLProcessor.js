...
export class ColorAttributePointerOpenGLProcessor extends ObjectThreedOpenGLProcessor {
    static getInstance() {
...
ColorAttributePointerOpenGLProcessor.instance = new ColorAttributePointerOpenGLProcessor();
