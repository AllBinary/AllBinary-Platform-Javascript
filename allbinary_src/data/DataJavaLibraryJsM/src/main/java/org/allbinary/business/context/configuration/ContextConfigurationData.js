...
export class ContextConfigurationData extends Object {
    static getInstance() {
    ...
    constructor() {
        super();
        this.NAME = "CONTEXT_CONFIGURATION_NAME";
...
ContextConfigurationData.instance = new ContextConfigurationData();
